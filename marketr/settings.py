...
DATABASES = {
    'default': {
        ...
        'HOST': 'vm2',                   # Set to empty string for localhost. Not used with sqlite3.
...
SECRET_KEY = '($-ml7gs=pgdgo*$s&amp;y8iq_230qtbout3p50rq)x_7oj*@&amp;nmf'
...
WSGI_APPLICATION = 'marketr.wsgi.application'

TEMPLATE_DIRS = (
    # Put strings here, like "/home/html/django_templates" or "C:/www/django/templates".
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/home/alexis/marketr/templates',
)
